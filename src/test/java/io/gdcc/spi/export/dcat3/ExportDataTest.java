...
class ExportDataTest {
    ...
    void testMaxSetParsesCorrectly()  {
        ...
        // -- prepare
        ExportDataProvider exportDataProvider = getExportDataProvider(  "src/test/resources/input/export_data_source_1" );
    ...
    void testSpecificSetParsesCorrectly()  {
        ...
        // -- prepare
        ExportDataProvider exportDataProvider = getExportDataProvider(  "src/test/resources/input/export_data_source_2" );
        ExportData result = ExportData.builder().provider( exportDataProvider ).build();
